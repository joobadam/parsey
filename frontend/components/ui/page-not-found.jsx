...
// funny 404 page, majd lehetne komolyabbat is csinálni
  ...
  return (
    <div
      ...
      <div
        ...
        <div className="text-[35px] font-semibold text-[#FF6B35] m-[1%]">
          Page Not Found
        </div>
        <div className="text-[80px] font-bold text-[#FF6B35] m-[1%]">
          404
        </div>
        <div className="text-[15px] w-1/2 min-w-[40%] text-center text-[#FF6B35]/70 m-[1%]">
          The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.
        </div>
        <div className="flex gap-6 mt-8">
          <button
            onClick={() => router.back()}
            className="text-white border-2 border-[#FF6B35] bg-[#FF6B35]/20 hover:bg-[#FF6B35] hover:text-white transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 rounded-lg">
            <svg
          ...
          <button
            ...
            className="bg-[#FF6B35] text-white hover:bg-[#FF6B35]/90 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 rounded-lg">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
